...
public class BoatGrader {
	...
	System.out.println(KThread.currentThread().getName()+" Adult arrived on Molokai as a passenger.");
    }

    /* AdultRideToOahu should be called when an adult not piloting
       the boat disembarks on Oahu */
    public void AdultRideToOahu() {
	System.out.println(KThread.currentThread().getName()+" Adult arrived on Oahu as a passenger.");
    }
}
