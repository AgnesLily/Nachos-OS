 ...
 */
public final class Lib {//final修饰的类不会被继承，其成员方法会被隐式的指定为final
    /**
     ...
     * superclass.
     *
     *判断两个类是否相同，或是另一个类的子类或实现了该接口
     * @param	cls	the descendant class.//子类
     * @param	superCls	the ancestor class.//父类
     */
     ...
     *
     *判断某类是否是公共类且不抽象，并且该构造函数的签名是确定存在的并且是公共的
     * @param	cls	the class containing the constructor.//含有构造器的一个类
     * @param	parameterTypes	the list of parameters.//参数列表
     */
